                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="<?php echo e(asset('public/assets/images/logo-sm.svg')); ?>" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="<?php echo e(asset('public/assets/images/logo-sm.svg')); ?>" alt="" height="22"> <span class="logo-txt">Astro</span>
                                </span>
                            </a>
                        ...
                        <div class="topnav">
                            <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                                ...
                                <div class="collapse navbar-collapse" id="topnav-menu-content">
                                    <ul class="navbar-nav">
                                        <li class="nav-item">
                                            <a class="nav-link dropdown-toggle arrow-none" href="<?php echo e(url('admin')); ?>" id="topnav-dashboard" role="button"
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <?php if(CustomHelper::isAllowedModule('user')){ ?>    
                                                <a href="<?php echo e(route('admin.user.index')); ?>" class="dropdown-item" data-key="t-calendar">User</a>
                                            <?php } ?>

                                            <?php if(CustomHelper::isAllowedModule('astrologer')){ ?>   
                                                <a href="apps-chat.html" class="dropdown-item" data-key="t-chat">Astrologer</a>
                                            <?php } ?>

                                            <?php if(CustomHelper::isAllowedModule('languages')){ ?>   
                                                <a href="<?php echo e(route('admin.languages.index')); ?>" class="dropdown-item" data-key="t-chat">Language</a>
                                            <?php } ?>

                                             <?php if(CustomHelper::isAllowedModule('expertises')){ ?>   
                                                <a href="<?php echo e(route('admin.expertises.index')); ?>" class="dropdown-item" data-key="t-chat">Expertises</a>
                                            <?php } ?>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="topnav-email">
                                                        <a href="<?php echo e(route('admin.countries.index')); ?>" class="dropdown-item" data-key="t-inbox">Country</a>
                                                        <a href="<?php echo e(route('admin.states.index')); ?>" class="dropdown-item" data-key="t-read-email">State</a>
                                                         <a href="<?php echo e(route('admin.cities.index')); ?>" class="dropdown-item" data-key="t-read-email">City</a>
                                                    </div>
                                                </div>
         ...
         -->
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block language-switch">
                            <button type="button" class="btn header-item"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="header-lang-img" src="<?php echo e(asset('public/assets/images/flags/us.jpg')); ?>" alt="Header Language" height="16">
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                    
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="eng">
                                    <img src="<?php echo e(asset('public/assets/images/flags/us.jpg')); ?>" alt="user-image" class="me-1" height="12"> <span class="align-middle">English</span>
                                </a>
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp">
                                    <img src="<?php echo e(asset('public/assets/images/flags/spain.jpg')); ?>" alt="user-image" class="me-1" height="12"> <span class="align-middle">Spanish</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                                    <img src="<?php echo e(asset('public/assets/images/flags/germany.jpg')); ?>" alt="user-image" class="me-1" height="12"> <span class="align-middle">German</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it">
                                    <img src="<?php echo e(asset('public/assets/images/flags/italy.jpg')); ?>" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italian</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                                    <img src="<?php echo e(asset('public/assets/images/flags/russia.jpg')); ?>" alt="user-image" class="me-1" height="12"> <span class="align-middle">Russian</span>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                ...
                                <div data-simplebar style="max-height: 250px;">
                                    <a href="#" class="text-reset notification-item">
                                        <div class="d-flex border-bottom align-items-start bg-light">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(asset('public/assets/images/users/avatar-3.jpg')); ?>"
                                    ...
                                    <a href="#" class="text-reset notification-item">
                                        <div class="d-flex border-bottom align-items-start">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(asset('public/assets/images/users/avatar-4.jpg')); ?>"
                                                    class="me-3 rounded-circle avatar-sm" alt="user-pic">
                                            </div>
                                            <div class="flex-grow-1">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item user text-start d-flex align-items-center" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="<?php echo e(asset('public/assets/images/users/avatar-1.jpg')); ?>"
                                alt="Header Avatar">
                            </button>
                            <div class="dropdown-menu dropdown-menu-end pt-0">
                                ...
                                <a class="dropdown-item" href="<?php echo e(url('admin/logout')); ?>"><i class='bx bx-log-out text-muted font-size-18 align-middle me-1'></i> <span class="align-middle">Logout</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="auth-logout.html" data-key="t-logout">Logsdfds Out</a></li>
            ...
            <!-- Left Sidebar End --><?php /**PATH /home/appmantr/public_html/astro.appmantra.live/resources/views/admin/common/sidebar.blade.php ENDPATH**/ ?>