...
Class TransactionsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $transactions = DB::table('wallet_transaction')->latest();
        if($role == 'user'){           
         $transactions->where('astrologer_id','=', null);
     }
     if($role == 'astrologer'){
        $transactions->where('user_id','=', null);
    }
   ...
   return view('admin.transactions.index',$data);
    ...
    //         if($role == 'user')
    //         {
    //            //echo  $users = DB::table('wallet_transaction')->select('id','user_id','amount','amount_type','amount_type_for','description')->where('astrologer_id','=', null)->get();


    //             // $users = DB::table('wallet_transaction')->leftJoin('users', 'wallet_transaction.user_id', '=', 'users.id')->get();
    //            // prd($users);
    //         }
    //         if($role == 'astrologer')
    //         {
    //             echo $users = DB::table('wallet_transaction')->select('id','astrologer_id','amount','amount_type','amount_type_for','description')->where('user_id','=', null)->get();
    //         }
    //     }
