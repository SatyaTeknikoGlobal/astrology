...
class CustomHelper{
    ...
    public static function getSadminRouteName(){
        $SADMIN_ROUTE_NAME = config('custom.SADMIN_ROUTE_NAME');

        if(empty($SADMIN_ROUTE_NAME)){
            $SADMIN_ROUTE_NAME = 'sadmin';
        }

        return $SADMIN_ROUTE_NAME;
    }
    ...
    public static function isAllowedSocietyModule($moduleName){
        ...
        $allowedModulesArr = config('modules.saallowed');
    ...
    public static function isAllowedSection($sectionName, $type=''){
        ...
        if($roleId == 0){
           ...
           $sectionpermission = Permission::where('section',$sectionName)->where($type,1)->first();
        ...
        try{
            ...
            Mail::send(
                ...
                function($message) use ($to, $from, $replyTo, $subject, $params) {
                    ...
                    if(!empty($from)){
                        $message->from($from,'Astro Guruji');
                    }
